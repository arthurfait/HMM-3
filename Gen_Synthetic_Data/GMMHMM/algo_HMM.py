    ...
    for cur_state,cur_arr in state_col.items():
        ...
        if num_vecs >= min_num_vecs:
        	...
        	for k in range(cur_mix_num):
        		...
        		#print "algo_HMM clustering: vecs_j_m ",vecs_j_m
...
def Baum_Welch(hmm,set_of_trobj,pseudoAC=0.0,pseudoWC=1.0,pseudoMC=0.0,pseudoUC=1.0,Scale=None,labels=None,maxcycles=10000,tolerance=DEF.small_positive,verbose=None):
   ...
   use_clustering = True
   one_more_cycle = True
   while cyc < maxcycles and (delta > tolerance or one_more_cycle == True):
       ...
       cyc=cyc+1
       if delta < tolerance:
       		if one_more_cycle == True:
       			one_more_cycle = False
       		elif one_more_cycle == False:
       			one_more_cycle = True
       #use_clustering = True
